...
const SolicitudesSuspencion = () => {
  ...
  const handleMostrarMensajeConfirmacion = (dato) => {
    ...
    setMensajeUsuario(
      'Está por eliminar el pedido de suspención de la clase con fecha: ' +
        formatearFecha(dato.fecha) +
        ' y hora: ' +
        formatearHora(dato.hora)
    )
  ...
  const handleAceptarBorrado = (e) => {
    ...
    fetch(
      `${URL_BASE}eliminar-suspender-clase/` + solicitudPorBorrar.id,
      requestOptions
    )
      .then((response) => response.json())
      .then((data) => {
    ...
    <div id="solicitudes-contenedorPrincipal">
          ...
          {cargando ? (
            ...
            <div id="contenedor-tabla">
              {solicitudes.length > 0 ? (
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <div id={'contenedor-buttonEliminarTablaSolicitudes'}>
                            <button
                              id={'button-eliminarTablaSolicitudes'}
                              onClick={() => handleEliminarSolicitud(dato)}
                            >
                              <p>
                                Eliminar{' '}
                                <FontAwesomeIcon
                ...
                <p className="mensajeTablaVacia-Cargando">
      ...
      <div id="mensajesUsuario" style={{ display: 'none' }}>
        ...
        <button
          ...
          onClick={handleCerrarMostrarMensajeConfirmacion}
          className="botones-MensajesUsuario"
        >
          Cancelar
        </button>
...
export default SolicitudesSuspencion

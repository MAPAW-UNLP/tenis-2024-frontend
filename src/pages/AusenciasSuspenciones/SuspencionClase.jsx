...
const SuspencionClase = () => {
  ...
  const handleSubmitContinue = (e) => {
    ...
    */
    ...
    const mensajeCargandosubmit = document.getElementById(
      'mensajeCargando-submit'
    )
  ...
  const construirMensaje = (data) => {
    ...
    mensaje += data.data.clasesAnteriores
      .map((clase) => {
        return (
    ...
    mensaje += data.data.clasesPosteriores
      .map((clase) => {
        return (
          formatearFecha(clase.fecha) + ' hora: ' + formatearHora(clase.horaIni)
        )
  ...
  const handleMostrarMensaje = (data) => {
    ...
    if (
      data.message ==
      'No existe una reserva para el día y horario ingresado. Quizas quiso mencionar algunas de estas clases:'
    ) {
  ...
  const handleCerrarMostrarMensaje = (e) => {
    ...
    if (
      mensajeUsuario ==
      'Se ha enviado al administrador un pedido de suspensión de clase.'
    ) {
    ...
    <div id="nuevaClase-contenedorPrincipal">
      ...
      <div id="nuevaClase-contenedor">
        ...
        >
          ...
          <p id="mensajeCargando-submit" style={{ display: 'none' }}>
            Cargando...
          </p>
        </button>
      </div>
      ...
      <div id="mensajesUsuario" style={{ display: 'none' }}>
        ...
        <button
          ...
          onClick={handleCerrarMostrarMensaje}

...
export const Movimientos = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="card cobros"
          style={{ marginRight: '1em' }}
          onClick={() => handleRedirect('../cobros')}
        >
          <div
            className="image"
            style={{ backgroundColor: '#75ebb0', position: 'relative' }}
          >
          ...
          <div className="content">
            ...
            <p className="desc">Movimiento de ingreso de dinero</p>
          </div>
        </div>
        ...
        <div className="card pagos" onClick={() => handleRedirect('../pagos')}>
          <div
            className="image"
            style={{ backgroundColor: '#f5a694', position: 'relative' }}
          >
            <div style={{ fontSize: '5em', color: '#5d5d5d' }}>
              <FontAwesomeIcon
                icon={faDollarSign}
          ...
          <div className="content">
            ...
            <p className="desc">Movimiento de egreso de dinero</p>
          </div>
        </div>

        <div
          className="card balance"
          style={{ marginTop: '1.2em', width: '38em', maxWidth: 'none' }}
        ...
        >
          ...
          <div className="content">
            ...
            <p className="desc">Balance general de los movimientos</p>
          </div>
        </div>
      </div>
    </>

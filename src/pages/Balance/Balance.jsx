...
export const Balance = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `${URL_BASE}balance-en-fecha?fecha_inicio=${datos.fechaInicio}&fecha_fin=${datos.fechaFin}&descripcion=${datos.descripcion}`,
      requestOptions
    )
              ...
              <div className="balance-head">
                ...
                >
                  ...
                  <InputReComponent
                    ...
                    name={'descripcion'}
                    id={'balanceDesc'}
                    className={'input-text-balance'}
                    placeholder={'Descripcion'}
                    onChangeFuncion={handleFiltro}
                  />
                </div>
                <button
                  className="button-balance-head"

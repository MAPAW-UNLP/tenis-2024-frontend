...
const ClaseDetails = ({
  ...
  return (
    <Modal isVisible={isVisible} onClose={cerrarDetalles} title="Detalles de la Clase">
      <div id="clase-detail-component">
            ...
            {active ? (
              <div id="clase-detail-contenido">
                ...
                <div id="clase-btn-background">
                  ...
                  />
                  <button id="clase-detail-edit-btn" onClick={() => setActive(false)}>
              ...
              <div id="clase-detail-contenido">
                ...
                <div id="clase-btn-background">
                  <button id="clase-detail-edit-btn" onClick={() => setActive(true)}>
        ...
        <div id="clase-detail-profesor" className="clase-caja">
          ...
          <div id="profesor-label">
            <p id="profesor">ID del profesor: </p> {/*TDOO mostrar el nombre, no el id*/}
          ...
          {alumnosDeLaClase.length > 0 ? (
            alumnosDeLaClase.map((alumno, index) => (
              <div key={index} className="alumno-item">
                ...
                <button onClick={() => handleDeleteAlumno(index)}>Eliminar</button>
              </div>
            ))
          ) : (

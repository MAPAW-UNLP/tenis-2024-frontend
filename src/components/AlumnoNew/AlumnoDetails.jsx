      ...
      {activeDetails && (
        <div className="new-alumno-details-component-container">
          <div className="new-alumno-details-component">
            <button
              className="close-new-alumno-details"
            ...
            >
              <div>
                ...
                <p className="new-alumno-inside-text">
                  Telefono: {aluDetail.telefono}
                </p>
                <GenericButton
                  marginBottom={'1.5em'}
                  backgroundColor={'#9195e6'}
                  color="white"
                  borderRadius="1em"
                  width="20em"
                  centrado
                  boxShadow={'0px 2px 1px #9195e6'}
                  onClick={() => setEditAlumnoActive(true)}
                >
                  Editar datos
                </GenericButton>
              </div>

...
export const EditarAlumno = ({
  ...
  const verifyFormEditAlumno = () => {
    ...
    if (!alumnoEditForm.telefono)
      verify.push('Debe ingresar un numero de telefono')
    setErrors(verify)
  ...
  return (
    <>
      {editAlumnoActive && (
        <div
          className="movimiento-add-component"
          style={{ boxShadow: '-2px -4px 400px 600px rgba(0, 0, 0, 0.64)' }}
        >
          <button
            className="close-movimiento-add-form"
            onClick={handleCloseEditAlumnoForm}
          >
            {' '}
            x{' '}
          </button>
          ...
          <form className="new-alumno-add-form">
            {/* Inputs */}
            <label htmlFor="nombreEdit" className="new-alumno-add-form-label">
              {' '}
              *{' '}
            </label>
            <InputReComponent
            ...
            <label htmlFor="nombre" className="new-alumno-add-form-label">
              {' '}
              *{' '}
            </label>
            <InputReComponent
            ...
            <button
              className="new-alumno-add-form-addBtn "
              style={{ marginTop: '.5em' }}
